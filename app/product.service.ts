...
export class ProductService {
  ...
  urlAdminProducts='http://localhost:8082/formafond/Api/product/products';
  urlProducts='';
  ...
  update(product: Product) {
    return this.http.put("http://localhost:8082/formafond/Api/product", product);
  }
  ...
  search(name, category, page, resultByPage): Observable<any> {
    return this.http.get("http://localhost:8082/formafond/Api/product/search" + name + category + page + resultByPage);
  }
